...
if ( ! class_exists( 'Site_Duplicate_Subcommand' ) ) :

	require_once realpath( dirname( __FILE__ ) ) . '/multisite-clone-duplicator/multisite-clone-duplicator.php';

	if ( class_exists( 'MUCD_Functions' ) && class_exists( 'MUCD_Duplicate' ) ) :
